...
{
    //Problema 1.1
    //Construya un programa que dado el costo de un artivulo vendido y la cantidad de dinero entregada por el cliente, calcule e imprima el cambio que debe entregar
